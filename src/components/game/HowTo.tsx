...
export const HOWTO = [
  ...
  { k: "Ход", v: "Тап — только лист клетки. Дело — второй тык по наклейке. «Ко мне» двигает взгляд, не ходит. Книга пускает шаг только на соседа (Чебышёв 1). Прыжок через реку и тын — «сюда не шагнул», силу не снимает. Ход идёт по часам: закрыл стол — фишка всё равно идёт.", i: ICO.boots },
  ...
  { k: "Рынок", v: "Прилавок игрока — на свободной клетке рынка, аренда 8 золота за неделю мира. Золото сгорает, казны нет. Не платил — вещь в кучу, клетка свободна. С одной почты один рыночный. У своей калитки двора — как было, без аренды.", i: ICO.gold },

...
import { BUILD_COST, BUILDING_LABEL, BUY_GOLD, PROFESSION_LABEL, SELL_GOLD, SELL_PACK, goldTxt } from "@/game/economy";
...
export const HOWTO = [
  { k: "Золото", v: "Большая цифра слева сверху. Сдаёшь добро в лавку на тракте — цифра растёт. Склад тракта 0…100: полон — не берут, пусто — не продают. Нигде нет буквы g: только «N золота».", i: ICO.gold },
  { k: "Сила", v: "Бак 18. Капает сама (~28 с). В шалаше нажми Спать — быстрее, ответ в окне шалаша. Кружка за 8 золота — сразу. Сила 0 не ест дерево: сидишь и ждёшь.", i: ICO.boots },
  { k: "Ход", v: "Тап — только лист клетки. Дело — второй тык по наклейке. «Ко мне» двигает взгляд, не ходит. Ход идёт по часам.", i: ICO.boots },
  { k: "Ноша", v: "Пешком 22 кг. Тачка — 20 золота или 8 дерева: 72 кг, шаг как пешком. Лошадь ×2½, ноша 28 кг. Телега — 48 золота в лавке или плотник: 2 колеса + 4 дерева + слиток. Цепляется к лошади, 180 кг, быстрее тачки, медленнее пустой лошади. В карман не кладётся: отцепил — стоит на клетке, её можно украсть.", i: ICO.bag },
  ...
  { k: "Зерно", v: "Своё поле даёт зерно. Дикая пашня — еда, как была. 2 зерна → мука дома или у печи. Пекарь: 2 муки → хлеб. Сырым зерно не едят.", i: ICO.food },
  ...
  { k: "Двор", v: "На листе клетки: «Угол двора», второй тап — «Замкнуть двор». Не кнопка дока. Док: Стоп · Ко мне · Съесть · Сумка. По краю тын. Без калитки тын не замкнёт — «Нужна калитка». Снял забор — дом на месте, серой заплаты нет. Пустой двор: первая наклейка — Шалаш. На шалаше при сырье — Дом. Калитка без замка — дыра.", i: ICO.stake },
  ...
  { k: "Услуга", v: "Повесил — висит, пока не снимешь или не возьмут. Срок только на дело: постой 15/30/60 мин стоять. Привези — исполнитель несёт своё на склад или калитку. Сделать и построить — как своё дело на станке. Ушёл раньше — золото заказчику.", i: ICO.gold },
  { k: "Доска", v: "Свой двор, даже лес, клетка у тына, улица имени. Лист: Висят / Повесить. Заказ пишут на цель, берут у доски или у цели. На саму клетку доски услугу не вешают.", i: ICO.house },

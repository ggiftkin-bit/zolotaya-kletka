...
export const HOWTO = [
  { k: "Золото", v: "Большая цифра слева сверху — счёт книги, не кармана. Сдаёшь добро в лавку на тракте — цифра растёт. С одной почты за сутки книги — 12 сдач; 13-я — «на сегодня хватит», золото не капает. Купить у тракта потолок не режет. Кружка, ускорить, залог, тачка — стол шлёт род дела, книга снимает цену. Подмена цифры в запросе не капает. Склад тракта 0…100: полон — не берут, пусто — не продают. Нигде нет буквы g: только «N золота».", i: ICO.gold },
  ...
  { k: "Тело", v: "Сытость, тепло и вода тела — счёт книги, как сила. Съел хлеб — сытость пишет книга. Напился у реки — вода 100. Ведро: набрал / глоток +25 / вылил. Подмена цифры в записи фишки не капает. Без еды и без глотка сами не растут. Тик тела только при живом столе: вкладка свёрнута — голод не каплет.", i: ICO.food },
  { k: "Ход", v: "Тап — только лист клетки. Дело — второй тык по наклейке. «Ко мне» двигает взгляд, не ходит. Без пути книга пускает только соседа (Чебышёв 1). «Пойти» — клетки этого пути, конец и ускорить 12 — последняя клетка, не прыжок мимо. Иначе «сюда не шагнул»: силу и 12 не снимает. Река и чужой тын — нет. Ход идёт по часам: закрыл стол — фишка всё равно идёт.", i: ICO.boots },
  ...
  { k: "Туман", v: "Видно одну-две клетки вокруг. За рекой — нет, вдоль реки — да. Дальше только стоя на горе, жиле или в своей башне. У подножия — как в поле. Тьма — «неизвестная клетка», не жила и не лес. Чужой двор снаружи — только тын и покров. Зайди внутрь (калитка без засова, пустили, или взлом) — видно, что за забором.", i: ICO.help },
  ...
  { k: "Кожа", v: "Охотиться может любой. Шкуру снимает только охотник. Кожу строгает любой дома: 2 шкуры + трава. Жилет (3 кожи) на тело, клобук (2 кожи) на голову — любой дома. Надел — старое в сумку. Стёганка и шлем из слитка как были.", i: ICO.bag },
  { k: "Огонь", v: "Поджечь — трава в руке, дело съест одну. Костёр рядом не зажигает. Калитку не жгут, засов жив. Сгоревший остов — «Разобрать»: в сумку уголь, не дерево. Свой целый шалаш или дом — «Разобрать»: половина цены назад, сундук кучей, тын на месте.", i: ICO.stake },
  ...
  { k: "Гибель", v: "Здоровье 0 в поле — упал на этой клетке, ноша кучей. Пока нокаут — ползи к шалашу, под крышей встанешь. Свою кучу стоя на ней можно поднять. Окно вышло в поле — погиб, фишка дома, хода нет сутки. Под крышей голод не валит. Первый раз даром, потом 10, 20 золота. Выйдешь дома через 2 мин. Партию не стираем. Свернул вкладку — голод и нокаут не бегут.", i: ICO.house },
  { k: "Стада", v: "Дикий заяц, олень, лошадь раз в сутки шагают на соседа. В реку, двор и тракт не идут. Две дикие лошади на клетке не стоят. Две коровы в загоне с кормом и водой — через 5 недель третья, потолок 4. Два своих коня у конюшни — через 2 сезона третий стоит рядом, не в сумке. Волк в лесу: шаг на клетку — лист встречи, за фишкой не бежит. Охотник свалил — шкура, бродяга — еда.", i: ICO.stake },
  { k: "Зал", v: "На поляне спавна. Игрок не строит и не жжёт. Контора здесь. Вокруг 8 клеток рынка.", i: ICO.house },
  { k: "Рынок", v: "Восемь клеток у зала — утоптанная площадь, не чёрный квадрат. Лист рынка: прилавок (дерево + аренда 8 золота за неделю) и доска. Шалаша, костра и грунта нет. Золото аренды сгорает, казны нет. Не платил — вещь в кучу, клетка свободна. С одной почты один рыночный. У своей калитки двора — как было, без аренды. Пустая поляна вне рынка — мир, не строят.", i: ICO.gold },
  { k: "Заказ", v: "Кнопку «Заказ» на зале видит только фишка с меткой книги staff. Два угла на земле, линия по четырём сторонам. Река и чужой двор — не встаёт. Золото словом, срок в сутках, потолок 80. Один подряд. Когда на всех клетках дорога — золото из воздуха. Срок вышел — заказ снова висит, золота нет.", i: ICO.road },
  { k: "Встреча", v: "Встань на клетку чужой фишки — лист, не автобой. С соседней листа нет. На поляне и у лавки тракта мира: удара, кражи, поджога и взлома нет, надпись «здесь мир». Двор за тыном — как был. Бой фишка-на-фишку на одной клетке есть: живой пишет удар в книгу. Армии нет.", i: ICO.stake },
  ...
  { k: "Доска", v: "Знак на тракте, берегу, поляне или рынке. В лес и чужой двор — нет. С одной почты два столба; третий — «хватит столбов», дерево не берут. 6 дерева. Обгорел — листа нет, счёт −1. Открой → Повесить: род и куда. На клетку доски услугу не вешают.", i: ICO.house },
  { k: "Контора", v: "В зале поляны, не у лавки тракта. Три приза словом: значок 200, кружка 500, подарок нфт 1000. Купил — золото сгорело, «заказан — выдаст админ». В сумку не кладётся. «Поддержать стол» — +50 золота на эту почту. Лавка тракта как была: сырьё пачкой, склад 0…100, биржа недели.", i: ICO.gold },
...
const PLAY = [
  ...
  {
    k: "Нужды",
    v: "Сила капает сама, еда её не копирует. Кружка 8 золота — сразу +4. Сон в шалаше — сила быстрее. Съесть — сытость. Река — вода тела 100. Под крышей тепло. Упал в поле — ползи в шалаш, под крышей поднимешься.",
    i: ICO.food,
  },
  {
    k: "Не сразу",
...
function AbcTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-[12px] text-muted-foreground">Сырьё пачкой. Готовое по штуке. Покупка в 3–4 раза дороже сдачи. Кружка 8 золота, ускорить 12, залог 20. Старт 20.</p>

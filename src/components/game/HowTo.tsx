...
export const HOWTO = [
  ...
  { k: "Двор", v: "На листе клетки: «Угол двора», второй тап — «Замкнуть двор». Не кнопка дока. Док: Стоп · Ко мне · Съесть · Сумка. По краю тын. Пустой двор: первая наклейка — Шалаш. На шалаше при сырье — Дом. Калитка без замка — дыра.", i: ICO.stake },

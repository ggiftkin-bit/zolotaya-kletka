...
export const HOWTO = [
  ...
  { k: "Сумка", v: "Док «Сумка» — квадраты по три в ряд, только то что есть. Тап: на землю, в сундук (свой шалаш/дом/склад), в руку (снасть).", i: ICO.bag },
  ...
  { k: "Снасть", v: "Топор, кирка, копьё, лопата ломаются. Топор ~160 рубок, кирка ~120 ударов, копьё ~60, лопата ~80. Сломалась — новой нет, кузнец или дом. Без топора дров мало. Без кирки камня мало. Верёвка, ведро, удочка пока целы.", i: ICO.axe },
  ...
  { k: "Встреча", v: "Чужая фишка рядом — лист, не автобой. Ударить, отойти, кинуть ношу, сдаться. Говорить — красноречие ≥3 или друг. Упал, не погиб. Закон после удара. Пока нет второго человека — манекен у хутора.", i: ICO.stake },

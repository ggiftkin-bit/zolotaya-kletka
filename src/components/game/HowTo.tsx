...
export const HOWTO = [
  ...
  { k: "Сумка", v: "Док «Сумка» — две вкладки: ноша и снасть. Счёт книги, не кармана: срубил — дерево пишет книга, закрыл стол — то же число. Подмена мешка в записи фишки не проходит. Квадраты по пять в ряд, только то что есть. Тап выбирает, ест и надевает плашка снизу. Сундук — полоска дома, в поле его нет. Профессия — в книге «Кем быть», не в ноше.", i: ICO.bag },

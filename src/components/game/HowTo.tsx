...
export const HOWTO = [
  ...
  { k: "Доска", v: "Знак на тракте, берегу, поляне или улице имени. Плот под доску не берётся. Лист — заказы хозяина столба; если есть имя улицы — плюс строки этого имени. Берут у доски или у цели. На саму клетку доски услугу не вешают. Обгорела — листа нет.", i: ICO.house },

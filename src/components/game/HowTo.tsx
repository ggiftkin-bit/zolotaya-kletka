...
export const HOWTO = [
  ...
  { k: "Гибель", v: "Здоровье 0 в поле — упал, куча на клетке падения, фишка сразу на своём шалаше. Шалаша нет — на зале. Свою кучу не поднять: тебя там нет. Под крышей голод не валит. 90 с — погиб. Первый раз даром, потом 10, 20 золота. Выйдешь дома через 2 мин, сутки без хода. Партию не стираем.", i: ICO.house },
...
const PLAY = [
  ...
  {
    k: "Нужды",
    v: "Сила капает сама, еда её не копирует. Кружка 8 золота — сразу +4. Сон в шалаше — сила быстрее. Съесть — сытость. Река — вода тела 100. Под крышей тепло. Упал в поле — фишка дома, куча на клетке падения.",
    i: ICO.food,
  },
  {
    k: "Не сразу",

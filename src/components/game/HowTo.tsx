...
export const HOWTO = [
  ...
  { k: "Услуга", v: "Повесил — висит, пока не снимешь или не возьмут. Срок только на дело: постой 15/30/60 мин стоять. Сделать и построить — как своё дело на станке. Ушёл раньше — золото заказчику.", i: ICO.gold },

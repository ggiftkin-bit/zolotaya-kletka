...
export const HOWTO = [
  ...
  { k: "Доска", v: "Свой двор, даже лес, клетка у тына, улица имени. Без имени лист пуст — саму доску ставят. Лист улицы: ордер и услуга. На саму доску услугу не вешают.", i: ICO.house },

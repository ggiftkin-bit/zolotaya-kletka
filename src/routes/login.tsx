  ...
  return (
    <main className="relative grid min-h-dvh place-items-center overflow-hidden bg-table p-6">
      ...
      <div className="relative z-10 w-full max-w-sm space-y-4 rounded-[28px] border border-border bg-panel p-6 shadow-panel">
        ...
        <h1 className="font-display text-3xl leading-none text-foreground">Войти за стол</h1>
        <p className="text-sm leading-relaxed text-muted-foreground">
          Фишка твоя. Поляна одна. Книга мира помнит клетку, даже когда вкладка спит.
        </p>
        {authEnabled ? (

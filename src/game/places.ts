...
export function placeHint(tile: Tile) {
  if (tile.caravan) return "Тачка и лошадь стоят на клетке, не в сумке. Телега 48, замок 16. Сырьё пачкой. Контора — в зале поляны.";
  switch (tile.building) {
    ...
    case "mill":
      return "Мельница. 2 зерна → 2 муки. Любой. Дом и печь — 2 → 1. Склад рядом кормит.";
    case "sawmill":
      return "Пилорама. 3 дерева → 2 доски. Любой. Верстак плотника — 3 → 1.";
    case "smoke":
    ...
    case "stall":
      return tile.market
        ? tile.owner === "you"
          ? "Рыночный прилавок. Аренда 8 золота в неделю мира. Не платил — вещь в кучу."
          : "Чужой рынок. Встань рядом — возьми, если хватает золота."
        : tile.owner === "you"
    ...
    case "board":
      ...
      return "Знак, не калитка. С одной почты два столба. Повесить заказ — цель двор, склад или калитка.";
    case "mine":
    case "adit":
    ...
    case "hall":
      return "Зал поляны. Контора. Мир. Прилавок — на клетке рынка, 8 золота в неделю.";
    default:
      return "";
  }
}
